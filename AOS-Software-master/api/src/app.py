...
# modes routes
from src.endpoints.modes.test_mode import test_mode 
from src.endpoints.modes.led_mode import led_on_mode, led_off_mode
...
def register_modes():
    app.register_blueprint(test_mode, url_prefix="/api/v1/test_mode")
    app.register_blueprint(led_on_mode, url_prefix="/api/v1/led_on_mode")
    app.register_blueprint(led_off_mode, url_prefix="/api/v1/led_off_mode")
